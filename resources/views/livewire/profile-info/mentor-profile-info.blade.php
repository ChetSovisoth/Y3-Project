    ...
    <div class="my-3">
        <form wire:submit="save">
            <div class="d-flex my-1">
                ...
                <input type="text" class="w-25 rounded-2 border border-0 p-1" placeholder="Area of Expertise" wire:model="area_of_expertise" value="{{ $area_of_expertise }}">
            </div>
            ...
            <div class="d-flex my-1">
                ...
                <input type="text" class="w-25 rounded-2 border border-0 p-1" placeholder="Experience" wire:model="experience" value="{{ $experience }}">
            </div>
            @error('experience')
                <div class="d-flex justify-content-end text-danger mt-1 mb-2">{{ $message }}</div>
            @enderror
